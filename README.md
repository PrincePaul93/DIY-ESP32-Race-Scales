...
- Battery monitoring for each pad
- Stability locking (auto-detect when weight settles)  
- Unit switching (lbs / kg)  
- Calibration and zeroing from browser via assistant
- Smart filtering for stable readings
- English, Spanish and German Language Support
- Different Car Syles including CG indication
- Color Options
...
- HX711 amplifier  1 for each pad or 3 for each pad depending on square or triangular scale shape
- 12 load cells 
